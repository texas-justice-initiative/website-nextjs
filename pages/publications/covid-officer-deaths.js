      ...
      <React.Fragment>
        ...
        <Layout>
          <Primary>
            <h1>{pageTitle}</h1>
            <p>
              Much of the country began to self-quarantine in early 2020, staying home from school and work. But for law enforcement officers, going to work was not optional, and meant risking getting{' '}
              <a href="https://experience.arcgis.com/experience/783fae2f8c0c4759a3ae1ccb7ef51668/page/page_0/">
                infected with COVID-19
              </a>
              . As of early September, more than 100 officers nationwide had died after contracting the coronavirus, “more than gun violence, car accidents and all other causes combined,” the <i>Washington Post</i>{' '} 
            ...
            <p>
              ...
              , the Texas Department of Criminal Justice and local law enforcement agencies. 
            </p>
            <CovidMap googleSheetsKey="1mOS1wggvyRUOpI-u2VabmnQ1yJPPEgOc2zdZjWxbAwQ" googleSheetsName="LEO Deaths" allDeathsOnly={true} />
          </Primary>
        </Layout>
      </React.Fragment>
    );
